...
import {AllHoldInfo, HeldTicket, LockTicket, TicketApi} from '../../../service/ticket/model/ticket.model';
...
export class SeatBookingComponent implements OnInit {
  ...
  displayTimer = '07:00';
  userId = '17d427d2-73c0-42bf-9813-24db3b1e3b6d';
  showTimeId!: string;
    ...
    if (info.status === 'AVAILABLE') {
      ...
      toLock.forEach(item =>
        this.ticketService.sendLockSeat({
          ...
          seatType: item.seatType}).subscribe(() => {
